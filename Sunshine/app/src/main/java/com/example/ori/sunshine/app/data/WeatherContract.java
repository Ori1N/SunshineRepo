 ...
 */
package com.example.ori.sunshine.app.data;
...
public class WeatherContract {
    ...
    */
    ...
    public static final class LocationEntry implements BaseColumns {
        ...
        // the location string that will be sent to openWeatehrMap as the location query
        public static final String COLUMN_LOCATION_SETTING = "location_setting";

        // city name (human readable location)
        public static final String COLUMN_CITY_NAME = "city_name";

        // latitude and longitude (keep the coordinates returned by openWeatherMap
